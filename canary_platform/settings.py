"""
Django settings for canary_platform project.
...
SESSION_COOKIE_NAME = 'canary_platform'
...
ROOT_URLCONF = 'canary_platform.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'canary_platform.views.global_setting'
            ],
        },
    },
]

WSGI_APPLICATION = 'canary_platform.wsgi.application'
